...
@section('content')
    ...
    <div class="text-center mb-8 fade-in">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1.5">Join OneBasket and start shopping from local vendors.</p>
    </div>
            ...
            <div class="fade-in delay-100">
                ...
                <div class="relative group">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required autofocus
                           class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800/50 pl-10 pr-4 py-2.5 text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-primary-500/40 focus:border-primary-500 outline-none transition-all duration-200 @error('name') border-red-400 focus:ring-red-500/40 focus:border-red-500 @enderror"
            ...
            <div class="fade-in delay-400">
                ...
                <div class="relative group">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" required
                           class="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800/50 pl-10 pr-4 py-2.5 text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-primary-500/40 focus:border-primary-500 outline-none transition-all duration-200"
                           placeholder="••••••••">
                </div>
            </div>
    ...
    {{-- Login link --}}
    <p class="mt-6 text-center text-sm text-gray-500 dark:text-gray-400 fade-in delay-600">
        Already have an account?
        <a href="{{ route('login') }}" class="text-primary-600 dark:text-primary-400 hover:text-primary-500 font-semibold transition-colors duration-200">Sign in</a>
    </p>

    {{-- Trust badge --}}
    <div class="mt-6 text-center fade-in delay-700">
