...
@section('content')
    ...
    <div class="max-w-2xl">
        <form method="POST" action="{{ isset($feature) ? route('admin.features.update', $feature) : route('admin.features.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="flex items-center justify-between gap-4 p-5 rounded-xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/80">
                <div class="text-xs text-gray-400"><span class="text-red-500">*</span> Required fields</div>
                <div class="flex items-center gap-3">
                    <a href="{{ route('admin.features.index') }}"
                       class="px-5 py-2.5 rounded-lg text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200 dark:hover:bg-gray-700 transition-all">Cancel</a>
                    <button type="submit"
